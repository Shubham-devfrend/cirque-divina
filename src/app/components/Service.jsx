...
const Service = () => {
  ...
  const subtitle = 'Our Studio Services';
            ...
            {Services.map((item, index) => (
              ...
              >
                <SpotlightCard
                  ...
                  spotlightColor="rgba(225, 229, 255, 0.2)"
                >
                  <div className="w-28 h-28 bg-[#472962] rounded-xl flex items-center justify-center">
                    <div className="bg-[#985acf] rounded-full w-16 h-16 flex justify-center items-center text-xl">
                      {item.icon}
                    </div>
                  </div>
                  <p className="font-bold text-xl text-[#c176ff]">{item.title}</p>
