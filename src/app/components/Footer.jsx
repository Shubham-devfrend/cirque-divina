...
const Footer = () => {
  return (
    <footer className="bg-[#29274c] text-white px-6 md:px-16 lg:px-32 py-12">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 border-b border-gray-700 pb-8">
        ...
        <div>
          ...
          <p className="text-gray-400 mb-4 py-2">Elevate Movement. Embody Artistry.</p>
          <div className="flex gap-4">
            <a href="#" className="bg-[#c176ff] p-3 rounded-full text-white hover:bg-yellow-600 transition">
              <FaInstagram />
            </a>
            <a href="#" className="bg-[#c176ff] p-3 rounded-full text-white hover:bg-yellow-600 transition">
              <FaFacebookF />
        ...
        <div>
          ...
          <div className="flex items-start gap-2 text-gray-400 mb-2">
            ...
            <p>Savannah, GA, United States</p>
          </div>
          <p className="text-gray-400 mt-2">+1 802-999-4237</p>
        </div>
        ...
        <div>
          ...
          />
          <button className="bg-[#c176ff] text-white font-semibold w-full py-2 rounded-md transition">
            Subscribe
          </button>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center pt-6 text-sm text-gray-400 gap-4">
        <p>© Praise God Beauty Salon. All rights reserved.</p>
        <div className="flex gap-4">
